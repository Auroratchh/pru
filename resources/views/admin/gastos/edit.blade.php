...
@section('content')
    ...
    <section class="main-content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    {!! Form::model($gasto,['url'=>'admin/gastos/'.$gasto->idGasto,'method' => 'PATCH', 'id'=>'FormEdit', 'class'=>'form-amc'])!!}
                    <div class="panel-result">
                        <div class="panel-result-heading">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h3 class="panel-title">Detalle del Gasto a editar</h3>
                                </div>
                    ...
                    <div class="text-end mt-5">
                        {!! Form::submit('ACTUALIZAR', ['id'=>'btnGuardar','class' => 'btn btn-dark btn-lg']) !!}
                    </div>
...
@section('javascript')
    ...
    <script src="{{ asset('js/admin/gastos/gastos_edit.js') }}"></script>
